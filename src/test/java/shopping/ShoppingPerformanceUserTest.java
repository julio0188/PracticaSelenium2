...
public class ShoppingPerformanceUserTest extends Base{
    ...
    public void shoppingEnd2EndTestPerformance(CredentialsModel credentialsModel,
    ...
    public Object[][] dataProviderCredentials() {
        ...
        return new Object[][]{
                {credentialsModelList.get(3), shoppingItemModelList, userDataModel}
        };
