...
public class ShoppingLockedUserTest extends Base {
    ...
    public void shoppingEnd2EndTestLocked(CredentialsModel credentialsModel,
    ...
    public Object[][] dataProviderCredentials() {
        ...
        return new Object[][]{
                {credentialsModelList.get(1), shoppingItemModelList, userDataModel}
        };
